...
灰royal
黑dark
若加边框则在色彩后-border背景色-bg

使用图标 i .icon  .ion-{icon-name}  font-size
	...
	ion-ios-cloud云
	ion-ios-help帮助
	ion-ios-person-outline用户名
	ion-ios-unlocked-outline锁
...
<div class="scroll-content">
	...
	<div class="bar bar-subheader light calm-bg">
		I'm sub-header
	</div>
...
line-height:
vertical-align:
CSS定义float后，元素变为块状元素，定义position：absolute后也成为块状元素
vertical-align：middle  百分比
