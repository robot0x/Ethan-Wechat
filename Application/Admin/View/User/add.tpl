            ...
            <form class="form-horizontal" name="form" action = "{:U('save')}" method = 'post'>
              ...
              <div class="form-group">
                <label for="username" class="col-sm-2 control-label">用户名：</label>
                  <div class="col-sm-4">
                    ...
                    <p class="" ng-show="form.username.$dirty && form.username.$invalid"> <span ng-show="form.username.$error.required">用户名不能为空</span></p>
                  </div>
              </div>
              ...
              <div class="form-group">
                <label for="name" class="col-sm-2 control-label">姓名：</label>
                  <div class="col-sm-4">
                    ...
                    <p class="" ng-show="form.name.$dirty && form.name.$invalid"> <span ng-show="form.name.$error.required">姓名不能为空</span></p>
                  </div>
              </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    ...
                    <p class="" ng-show="form.email.$dirty && form.email.$invalid"> <span ng-show="form.email.$error.required">邮箱不能为空</span></p>
                  </div>
              </div>
              <div class="form-group">
