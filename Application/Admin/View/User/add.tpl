...
<block name="body">
  <div class="row-fluid">
    ...
    <form <eq class="form-horizontal" name = "Think.ACTION_NAME" value = "add"> action = "{:U('save')}" <else/> action = "{:U('update')}" </eq> method = 'post'>
      ...
      <div class="form-group">
        <label for="phonenumber" class="col-sm-12 control-label">手机号：</label>
        <div class="col-sm-5">
